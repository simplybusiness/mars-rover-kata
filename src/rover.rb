...
class Rover
  ...
  def move_forward
    case @direction
    when 'N'
      @coordinates = @coordinates.change_y
    when 'S'
      @coordinates = @coordinates.change_y(increase: false)
    when 'E'
      @coordinates = @coordinates.change_x
    when 'W'
      @coordinates = @coordinates.change_x(increase: false)
    end
  end
