...
RSpec.describe MarsRover do
  ...
  describe 'a North facing Mars Rover can move forwards or backwards' do
    ...
    it 'move multiple steps forward' do
      ...
      expect(mars_rover).to eq(MarsRover.new(x: 0, y: 3, orientation: "N"))
    end
  ...
  describe 'a East facing Mars Rover can move forwards or backwards' do
    ...
    it 'moves multiples step forward' do
      ...
      expect(mars_rover).to eq(MarsRover.new(x: 3, y: 0, orientation: "E"))
    end
  ...
  describe 'a South facing Mars Rover can move forwards or backwards' do
    it 'moves the rover forward by one space' do
      ...
      expect(mars_rover).to eq(MarsRover.new(x: 0, y: -1, orientation: "S"))
    end
    ...
    it 'moves the rover multiples steps forward' do
      ...
      expect(mars_rover).to eq(MarsRover.new(x: 0, y: -3, orientation: "S"))
    end
  ...
  describe 'a West facing Mars Rover can move forwards or backwards' do
    it 'moves the rover forward by one space' do
      ...
      expect(mars_rover).to eq(MarsRover.new(x: -1, y: 0, orientation: "W"))
    end
    ...
    it 'moves the rover multiple steps forward' do
      ...
      expect(mars_rover).to eq(MarsRover.new(x: -3, y: 0, orientation: "W"))
    end
  ...
  describe "can do a full move around the planet" do
    it 'moves forward North enough distance it ends in the same starting point' do
      mars_rover = MarsRover.new(x: 0, y: 0, orientation: "N")

      mars_rover.process_movement_commands("f"*10)

      expect(mars_rover).to eq(MarsRover.new(x: 0, y: 0, orientation: "N"))
    end

    it 'moves backwards while facing East enough distance it ends in the same starting point' do
      mars_rover = MarsRover.new(x: 0, y: 0, orientation: "E")

      mars_rover.process_movement_commands("b"*10)

      expect(mars_rover).to eq(MarsRover.new(x: 0, y: 0, orientation: "E"))
    end
  end
end
