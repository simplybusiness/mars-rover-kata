...
describe MarsRover do
  ...
  it 'moves forwards when facing north' do
    ...
    expect(mars_rover.point.coordinates).to eq '[0 1 N]'
  end
  ...
  it 'moves forwards when facing south' do
    ...
    expect(mars_rover.point.coordinates).to eq '[0 0 S]'
  end
  ...
  it 'moves forwards when facing east' do
    ...
    expect(mars_rover.point.coordinates).to eq '[1 0 E]'
  end
  ...
  it 'moves backwards when facing north' do
    ...
    expect(mars_rover.point.coordinates).to eq '[0 0 N]'
  end
  ...
  it 'moves backwards when facing south' do
    ...
    expect(mars_rover.point.coordinates).to eq '[0 1 S]'
  end
end
