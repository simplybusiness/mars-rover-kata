...
RSpec.describe Rover do
  ...
  describe 'movement' do
    context 'forward' do
      it_behaves_like 'a single-step command', 'f',
    ...
    context 'backward' do
      it_behaves_like 'a single-step command', 'b',
                      'facing N' => { start: :N, x: 0,  y: -1, direction: :N },
                      'facing E' => { start: :E, x: -1, y: 0,  direction: :E },
                      'facing S' => { start: :S, x: 0,  y: 1,  direction: :S },
                      'facing W' => { start: :W, x: 1,  y: 0,  direction: :W }
  ...
  describe 'rotation' do
    context 'right' do
      it_behaves_like 'a single-step command', 'r',
    ...
    context 'left' do
      it_behaves_like 'a single-step command', 'l',
